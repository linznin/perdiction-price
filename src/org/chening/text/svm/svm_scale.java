...
class svm_scale
{
    ...
    private BufferedWriter scaleWrite = null;
    ...
    private void run(String []argv) throws IOException
    {
        ...
        for(i=0;i<argv.length;i++)
        {
            ...
            switch(argv[i-1].charAt(1))
            {
                ...
                case 'd': scale_filename = argv[i]; break;
                default:
        ...
        if (scale_filename != null ){
            scaleWrite = new BufferedWriter(new FileWriter(scale_filename));
        }
