...
import org.chening.text.csv.CsvFile;
...
public class PSOProcess implements PSOConstants {
	...
	private String dataPath = ProSetting.LDA_DATA_PATH + ProSetting.ORG_DATA;
...
//			w = W_UPPERBOUND - (((double) t) / MAX_ITERATION) * (W_UPPERBOUND - W_LOWERBOUND);
	...
	private void recordResult(String gBest,String location, Long time){
		...
		try (FileWriter writer = new FileWriter(ProSetting.PSO_RESULT_FILE, true))
		{
			writer.append("****************************************************** \n");
